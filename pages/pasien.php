<?php
include 'controller/pasien/post_pasien.php';
?>
    ...
    <section class="content-header">
        <div class="container-fluid">
            ...
            <div class="card card-default color-palette-box">
                ...
                <div class="card-body">
                <?php
                    if (isset($_SESSION['msg_simpan_pasien'])) {
                    ?>
                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                            <span class="fas fa-check fe-16 mr-2"></span> <?= flash('msg_simpan_pasien'); ?>
                    ...
                    ?>
                     <?php
                    if (isset($_SESSION['msg_hapus_pasien'])) {
                    ?>
                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                            <span class="fas fa-check fe-16 mr-2"></span> <?= flash('msg_hapus_pasien'); ?>
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                    ...
                    ?>
                    <?php
                    if (isset($_SESSION['msg_edit_pasien'])) {
                    ?>
                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                            <span class="fas fa-check fe-16 mr-2"></span> <?= flash('msg_edit_pasien'); ?>
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                    ...
                    ?>
                    <button type="button" class="btn btn-primer mt-2" data-toggle="modal" data-target="#modal-xl">
                        <i class="fas fa-plus-circle"></i> Pasien
                    </button><br><br>
                    <table class="table" id="dataTable">
                        ...
                        <tbody>
                            <?= tampil_pasien($database, $base_url) ?>
                        </tbody>
                    </table>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="radio" name="penderita" value="Hipertensi" id=""> Hipertensi <br>
                                <input type="radio" name="penderita" value="Diabetes Melitus" id=""> Diabetes Melitus <br>
                                <input type="radio" name="penderita" value="Jantung" id=""> Jantung
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
